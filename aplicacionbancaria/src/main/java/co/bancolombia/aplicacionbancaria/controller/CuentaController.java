...
public class CuentaController {
    ...
    public String obtenerSaldo(@PathVariable Integer nroCuenta) {
       return cuentaService.obtenerSaldo(nroCuenta);
    }

    //Depositar a una cuenta.
    @PostMapping("/deposito/{nroCuenta}/{monto}")
    public String depositar(@PathVariable Integer nroCuenta, @PathVariable BigDecimal monto) {
       return cuentaService.depositar(nroCuenta, monto);
    }

    //Retirar de una cuenta.
    @PostMapping("/retiro/{nroCuenta}/{monto}")
    public String retirar(@PathVariable Integer nroCuenta, @PathVariable BigDecimal monto) {
